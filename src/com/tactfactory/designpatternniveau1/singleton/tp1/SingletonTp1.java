...
import com.tactfactory.designpatternniveau1.singleton.tp1.entities.MonSingleton;
...
public class SingletonTp1 {
  public static void main(String[] args) {
    ...
    System.out.println(String.format("Nombre d'Entity1 %d", MonSingleton.getInstance().list.stream().count()));
